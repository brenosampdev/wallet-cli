...
public class ListByIdTransactionValidation implements ValidationRule {
  public static final ListByIdTransactionValidation INSTANCE = new ListByIdTransactionValidation();

  private ListByIdTransactionValidation() {}
