...
public class ListByNameCategoryValidation implements ValidationRule {
  public static final ListByNameCategoryValidation INSTANCE = new ListByNameCategoryValidation();

  private ListByNameCategoryValidation() {}
